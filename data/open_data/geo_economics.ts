...
export const GEO_ECONOMICS: VerifiableDataset<Record<string, GeoProfile>> = {
  meta: {
    source: "Ministry of Interior (內政部不動產資訊平台) & Numbeo",
    dataset_id: "Residential Property Price Index Q4 2023",
    published_at: "2024-04",
    confidence: 0.85,
    note: "Cost multiplier derived from rent-to-income ratio per city."
  },
  data: {
    // 1. 天龍國 (Taipei Core)
    "taipei_core": {
