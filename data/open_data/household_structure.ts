...
export const HOUSEHOLD_STRUCTURES: VerifiableDataset<Record<string, HouseholdProfile>> = {
  meta: {
    source: "DGBAS (主計總處家庭收支調查)",
    dataset_id: "Household Income and Expenditure 2022",
    published_at: "2023-08",
    confidence: 0.9,
    note: "Discretionary factor inverted from Engel's coefficient and housing expenditure."
  },
  data: {
    // 1. 單身游牧 (1人戶)
    "solo_nomad": {
