...
export const OCCUPATION_TIME_PRINTS: VerifiableDataset<Record<string, TimeProfile>> = {
  meta: {
    source: "Combined Analysis: DGBAS Time Use Survey & Digital Footprint",
    dataset_id: "Taiwan Behavioral Chronotypes v2.0",
